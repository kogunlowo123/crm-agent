...
app = FastAPI(
    title="CRM Agent",
    description="CRM automation agent that maintains customer records, logs interactions, tracks customer health scores, triggers engagement workflows, and surfaces account insights for sales and support teams.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
