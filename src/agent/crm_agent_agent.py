"""CRM Agent - Main Agent Implementation."""
...
class CrmAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "update_contact": self.tools.update_contact,
            "log_interaction": self.tools.log_interaction,
            "calculate_health_score": self.tools.calculate_health_score,
            "trigger_workflow": self.tools.trigger_workflow,
            "surface_insights": self.tools.surface_insights,
        }
        logger.info(
            "agent_initialized",
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "surface_insights": ['surface', 'insights'],
        }
