"""CRM Agent - Domain-Specific Connectors."""
...
class ZendeskConnector:
    """Domain-specific connector for zendesk integration with CRM Agent."""
...
class IntercomConnector:
    """Domain-specific connector for intercom integration with CRM Agent."""
...
class SalesforceServiceConnector:
    """Domain-specific connector for salesforce service integration with CRM Agent."""
...
class FreshdeskConnector:
    """Domain-specific connector for freshdesk integration with CRM Agent."""
...
class HubspotServiceConnector:
    """Domain-specific connector for hubspot service integration with CRM Agent."""
